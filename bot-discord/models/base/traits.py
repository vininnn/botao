...
class OpenableRoom(ABC):
    ...
    @abstractmethod
    def open(self) -> None:
        """Defines the logic to initialize/start a room."""
        pass
...
class CloseableRoom(ABC):
    ...
    @abstractmethod
    def close(self) -> None:
        """Defines the logic to finalize a room."""
        pass
...
class JoinableRoom(ABC):
    ...
    def join(self, user_id: int) -> None:
        """Registers a user into the room."""
        pass

    @abstractmethod
    def leave(self, user_id: int) -> int:
        """Removes a user and returns their individual room duration."""
        pass
